<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditUsers.aspx.cs" Inherits="UserManagerDemo.EditUsers" Theme="Default" %>
        ...
        <div id="div1">
            ...
            <table class="tb_content">
                ...
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="ddluImage" runat="server" AutoPostBack="True">
                ...
                <tr>
                   <td align="right"><asp:Button ID="btnEidt" Text="修改" runat="server" OnClick="btnEidt_Click"/></td>
                    <td>
                        &nbsp;</td>
                </tr>
            </table>
