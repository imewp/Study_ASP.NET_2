<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UsersManager.aspx.cs" Inherits="UserManagerDemo.UsersManager" Theme="Default" %>
...
<body>
    ...
    【会员管理】<hr/>
        ...
        <br />
        <br />
        <asp:GridView ID="gvUsers" runat="server" DataKeyNames="uID" AutoGenerateColumns="False" OnRowDeleting="gvUsers_RowDeleting">
            <Columns>
