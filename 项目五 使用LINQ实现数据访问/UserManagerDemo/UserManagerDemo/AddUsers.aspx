<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddUsers.aspx.cs" Inherits="UserManagerDemo.AddUsers" Theme="Default" %>
        ...
        <div id="div1">
            ...
            <table class="tb_content">
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtuRealName" runat="server"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <asp:CheckBoxList ID="cbluHobby" runat="server" RepeatDirection="Horizontal" CssClass="nobordertb">
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtuPhone" runat="server"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td align="right">头像：</td>
                    <td>
                        <asp:DropDownList ID="ddluImage" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddluImage_SelectedIndexChanged">
                        ...
                        <asp:Image ID="imguImage" runat="server" Height="40px" ImageUrl="~/Images/userico/1.gif" Width="40px" />
                    </td>
                </tr>
                <tr>
                   <td align="right"><asp:Button ID="btnAdd" Text="添加" runat="server" OnClick="btnAdd_Click"/></td>
                    <td>
                        &nbsp;</td>
                </tr>
            </table>
